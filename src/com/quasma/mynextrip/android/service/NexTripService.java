...
public class NexTripService extends IntentService 
{
	...
	public static final String URL_EXTRA = "com.quasma.mynextrip.android.service.URL_EXTRA";
		...
		switch (resourceType) 
		{
			...
			case RESOURCE_TYPE_DIRECTION:
				...
				if (method.equalsIgnoreCase(METHOD_GET)) 
				{
					...
					String url = requestIntent.getExtras().getString(NexTripService.URL_EXTRA);
					DirectionProcessor processor = new DirectionProcessor(getApplicationContext(), url, route);
			...
			case RESOURCE_TYPE_STOP:
				if (method.equalsIgnoreCase(METHOD_GET)) 
				{
					...
					String url = requestIntent.getExtras().getString(NexTripService.URL_EXTRA);
					StopProcessor processor = new StopProcessor(getApplicationContext(), url, route, direction);
			...
			case RESOURCE_TYPE_TRIP:
				...
				{
					String url = requestIntent.getExtras().getString(NexTripService.URL_EXTRA);
					TripProcessor processor = new TripProcessor(getApplicationContext(), url);
