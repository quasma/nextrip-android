...
public class NexTripServiceHelper 
{
	...
	public long getDirections(String uri, String route)
	{
		long requestId = generateRequestID();
		...
		intent.putExtra(NexTripService.URL_EXTRA, uri);
		intent.putExtra(NexTripService.SERVICE_CALLBACK, serviceCallback);
		intent.putExtra(REQUEST_ID, requestId);
	...
	public long getStops(String uri, String route, String direction)
	{
		long requestId = generateRequestID();
	...
	public long getTrips(String uri)
	{
		long requestId = generateRequestID();
